...
class Particle:
	...
	def Draw(self, display):
		...
		if self.drawtype == DRAWTYPE_POINT:  # Point
			...
			if self.radius >= 1.0:
				pygame.draw.circle(display, self.colour, (int(self.pos[0]), int(self.pos[1])), self.radius, 1)
				...
				pygame.draw.circle(display, self.colour, (int(self.pos[0]), int(self.pos[1])), self.radius)
